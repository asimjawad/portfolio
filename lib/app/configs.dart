...
mixin PersonalDetails {
  ...
  static const String resumeLink = 'https://drive.google.com/file/d/1hsFBAqrcNFYdP_1D6r3ERXZNOw2-wWSh/view?usp=share_link';
  static const String whatsappLink = 'https://wa.me/03036308035';
  ...
  static List<Project> projectsList = [
    Project(
      ...
      description: 'Created a hostel management web app to track students where they are, and download data of attendance for each day',
      tools: [
        'Redux',
        'Node Js',
        'Express Js',
    ...
    Project(
      ...
      description: 'An ECommerce application similar to amazon or flipkart where users can buy products,contains admin panel',
      tools: [
        'Redux',
        'Node Js',
        'Express Js',
    ...
    Project(
      ...
      description: 'Created a flutter package for building customized and aesthetic graphs.Built with the help of custom graphs.',
      tools: [
        'Flutter',
      ],
    ),
    Project(
      ...
      description: 'Mobile Application to detect whether person wears a mask or not.Built with Flutter and tensorflow lite.',
      tools: [
        'Flutter',
        'Tflite',
        'CNN',
    ...
    Project(
      ...
      description: 'Created a simple application to show how to perform crud operations using flask,react and mongo db and includes how to search by name.',
      tools: [
        'Flask',
        'React',
        'Mongo DB',
    ...
    Project(
      ...
      description: 'An application to schedule alarms on multiple devices supports for both android and ios,built using mongo db and flutter.',
      tools: [
        'Flutter',
        'Mongo DB',
        'Node Js',
    ...
    Project(
      ...
      description: 'Application which shows how to cache rest api data,so that user can view data even though he is offline.Presently supports for web, android and ios',
      tools: [
        'Flutter',
        'Hive',
      ],
    ...
    Project(
      ...
      playstoreLink: 'https://play.google.com/store/apps/details?id=com.cse.cynosure',
      githubLink: 'https://github.com/shashiben/College-Fest-app',
      description: 'Created an app for college fest where users can register for events and get live notifications regarding events and has payment gateway integration.',
      tools: [
        'Java',
        'Firebase',
        'Paytm',
    ...
    Project(
      ...
      description: 'Backend for sending mails.Used to add functionality of sending mail without opening any other applications',
      tools: [
        'Node JS',
        'Email JS',
        'Express JS',
  ...
  static List<SkillModel> featuredSkills = [
    SkillModel(name: 'Mobile Application Developement', percent: 100),
